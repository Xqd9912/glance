# PyInstaller spec for the desktop sidecar: the Glance API server, frozen so that
...
PACKAGE_DATA = PROJECT_ROOT / "src" / "glance" / "structures"
...
datas = [
    ...
    (str(PACKAGE_DATA / "scene_contract.json"), "glance/structures"),
    (str(PACKAGE_DATA / "covalent_radii.json"), "glance/structures"),
...
a = Analysis(
    [str(PROJECT_ROOT / "src" / "glance" / "desktop.py")],
