...
This is a separate entry point from `glance gui` on purpose: the GUI command serves the page
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Glance desktop API sidecar.")
