...
from glance.structures.connectivity import ConnectedAtom, ConnectivityResult
...
from glance.structures.schema import PolyhedronSpec
from glance.structures.visibility import (
